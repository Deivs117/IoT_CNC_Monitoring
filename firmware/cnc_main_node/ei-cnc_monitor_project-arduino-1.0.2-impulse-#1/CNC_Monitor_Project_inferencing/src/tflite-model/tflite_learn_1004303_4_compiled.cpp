 ...
 */
// Generated on: 26.05.2026 02:44:13
...
const TfArray<1, float> quant0_scale = { 1, { 0.029718929901719093, } };
const TfArray<1, int> quant0_zero = { 1, { 10 } };
const TfLiteAffineQuantization quant0 = { (TfLiteFloatArray*)&quant0_scale, (TfLiteIntArray*)&quant0_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(8) int32_t tensor_data1[3] = { -2, 4, -5, };
const TfArray<1, int> tensor_dimension1 = { 1, { 3 } };
const TfArray<1, float> quant1_scale = { 1, { 0.0030653614085167646, } };
const TfArray<1, int> quant1_zero = { 1, { 0 } };
const TfLiteAffineQuantization quant1 = { (TfLiteFloatArray*)&quant1_scale, (TfLiteIntArray*)&quant1_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int8_t tensor_data2[3*16] = { 
  39, -19, 8, 40, -7, 46, 31, 30, 24, -37, -23, 16, -32, -25, -17, -42, 
  -67, 39, -41, -76, -20, -9, -10, -56, -17, 113, 81, -29, -20, 79, 18, 127, 
  10, -55, 90, 6, 101, -37, -51, 73, -52, 7, -15, 80, 98, 27, -54, -33, 
};
const TfArray<2, int> tensor_dimension2 = { 2, { 3,16 } };
const TfArray<1, float> quant2_scale = { 1, { 0.033414114266633987, } };
const TfLiteAffineQuantization quant2 = { (TfLiteFloatArray*)&quant2_scale, (TfLiteIntArray*)&g0::quant1_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int32_t tensor_data3[16] = { 17, 114, 462, -103, -6, -91, 16, 538, 13, -158, -36, -6, 212, 300, 127, -93, };
const TfArray<1, int> tensor_dimension3 = { 1, { 16 } };
const TfArray<1, float> quant3_scale = { 1, { 0.00082490534987300634, } };
const TfLiteAffineQuantization quant3 = { (TfLiteFloatArray*)&quant3_scale, (TfLiteIntArray*)&g0::quant1_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int8_t tensor_data4[16*8] = { 
  -1, 0, 9, 13, 39, 8, 65, -125, 
  -14, -33, -36, -36, 1, -28, 19, -34, 
  -7, 3, 26, 55, 19, 20, 93, -9, 
  18, -7, 29, -5, -5, -6, -53, 98, 
  6, 20, -51, 27, -35, 2, 42, 29, 
  1, -14, 90, -27, -2, -22, -47, -12, 
  -8, -19, 72, -25, 17, -24, -44, -23, 
  -4, 19, 125, 14, 20, -2, 110, -20, 
  16, 8, 29, -4, 5, -5, -19, 63, 
  -14, 48, 11, 20, 26, 42, -38, 119, 
  -4, 24, 8, 58, -14, 10, -19, 89, 
  -48, 12, -18, 58, -14, 14, 62, 22, 
  -39, 37, 30, 74, -28, 46, 77, 21, 
  -31, 15, 88, -11, 127, 91, -38, 67, 
  -13, -36, -50, -36, -26, -28, 23, -55, 
  35, 68, 20, 42, -11, 24, -45, 116, 
};
const TfArray<2, int> tensor_dimension4 = { 2, { 16,8 } };
const TfArray<1, float> quant4_scale = { 1, { 0.02775689959526062, } };
...
const TfArray<1, float> quant5_scale = { 1, { 0.091738522052764893, } };
const TfArray<1, int> quant5_zero = { 1, { -128 } };
const TfLiteAffineQuantization quant5 = { (TfLiteFloatArray*)&quant5_scale, (TfLiteIntArray*)&quant5_zero, 0 };
const TfArray<2, int> tensor_dimension6 = { 2, { 1,3 } };
const TfArray<1, float> quant6_scale = { 1, { 0.82823628187179565, } };
const TfArray<1, int> quant6_zero = { 1, { -61 } };
...
{ kTfLiteArenaRw, kTfLiteInt8, (int32_t*)(tensor_arena + 16), (TfLiteIntArray*)&g0::tensor_dimension0, 8, {kTfLiteAffineQuantization, const_cast<void*>(static_cast<const void*>(&g0::quant0))}, },
...
{ kTfLiteArenaRw, kTfLiteInt8, (int32_t*)(tensor_arena + 0), (TfLiteIntArray*)&g0::tensor_dimension5, 16, {kTfLiteAffineQuantization, const_cast<void*>(static_cast<const void*>(&g0::quant5))}, },
...
TfLiteStatus tflite_learn_1004303_4_init( void*(*alloc_fnc)(size_t,size_t) ) {
...
TfLiteStatus tflite_learn_1004303_4_input(int index, TfLiteTensor *tensor) {
  init_tflite_tensor(in_tensor_indices[index], tensor);
  return kTfLiteOk;
}

TfLiteStatus tflite_learn_1004303_4_output(int index, TfLiteTensor *tensor) {
  init_tflite_tensor(out_tensor_indices[index], tensor);
  return kTfLiteOk;
}

TfLiteStatus tflite_learn_1004303_4_invoke() {
...
TfLiteStatus tflite_learn_1004303_4_reset( void (*free_fnc)(void* ptr) ) {
#ifdef EI_CLASSIFIER_ALLOCATION_HEAP
